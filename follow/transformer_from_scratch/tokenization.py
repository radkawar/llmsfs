...
def build_tokenizer(
    ...
    special_tokens = list(dict.fromkeys([*SPECIAL_TOKENS, *additional_special_tokens]))
    ...
    return TOKENIZER_BUILDERS[tokenizer_type].build(sentences, vocab_size, min_frequency, special_tokens)
